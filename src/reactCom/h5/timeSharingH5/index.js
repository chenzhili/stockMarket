...
class TimeSharingH5 extends Component {
  ...
  componentDidMount () {
    ...
    const curData = QLStockMarketIns._data.data[QLStockMarketIns._data.data.length - 1]
  ...
  render () {
    ...
    const { upToData, curData, QLStockMarketIns, upOrDown, valueBorder, decimal } = this.state
